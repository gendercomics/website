  ...
  (function () {
    ...
    window.Event = Window.prototype.Event = function Event(type, eventInitDict) {
      ...
      if ('createEvent' in document) {
        ...
        const bubbles = eventInitDict && eventInitDict.bubbles !== undefined ? eventInitDict.bubbles : false;
        const cancelable = eventInitDict && eventInitDict.cancelable !== undefined ? eventInitDict.cancelable : false;
      ...
      window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function addEventListener() {
        ...
        if (!element._events[type]) {
          element._events[type] = function (event) {
            const
              { list } = element._events[event.type];
