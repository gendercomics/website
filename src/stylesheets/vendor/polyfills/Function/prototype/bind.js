...
(function (undefined) {
  ...
  Object.defineProperty(Function.prototype, 'bind', {
    value: function bind(that) { // .length is 1
      ...
      let isCallable; /* inlined from https://npmjs.com/is-callable */ const fnToStr = Function.prototype.toString; const tryFunctionObject = function tryFunctionObject(value) { try { fnToStr.call(value); return true; } catch (e) { return false; } }; const fnClass = '[object Function]'; const
        genClass = '[object GeneratorFunction]'; isCallable = function isCallable(value) { if (typeof value !== 'function') { return false; } if (hasToStringTag) { return tryFunctionObject(value); } const strClass = to_string.call(value); return strClass === fnClass || strClass === genClass; };
